...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val items: List<PageItem> = listOf(
            RepositoryPage(profile.username, profile.repository.toInt()),
            FollowingPage(profile.username, profile.following.toInt()),
            FollowersPage(profile.username, profile.followers.toInt()),
        )
